...
@section('content')
    ...
    <section id="cta" class="wrapper">
        <div class="inner">
            <h2># Stay Home Posts</h2>
            <a href="#menu">Menu</a>
            <p>Entertainments can be found anywhere, even when you at home. Share your stories about your quarantine and
                see other stories in this forum.</p>
            <div>
                <nav>
                    <ul>
                    ...
                    <div class="container h-50">
                        <div class="row justify-content-center">
                            @guest()
                                ...
                                <h1 class="text-center"> Staying Home Topic page</h1>
                            @endguest
                        <!--Posting section-->
                            @auth
                                <div class="col-md-8 pb-5">
                                    ...
                                    <div class="card" style="border:2px; border-style:solid; border-color:#e5e5e5;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <form action="/StayHomeTopic/post" method="POST"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right"
                                                                    ...
                                                                    <a class="dropdown-item"
                                                                       href="/post/{{$post->id}}/delete">Delete
                                                                        Post</a>
                                                                    <a class="dropdown-item"
                                                                       href="/StayHomeTopic/post/{{$post->id}}/edit">Edit
                                                                        Post</a>
